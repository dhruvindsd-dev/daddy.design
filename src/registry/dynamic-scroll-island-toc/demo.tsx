  ...
  return (
    <div className="flex flex-col">
      <MotionConfig transition={{ duration: 0.6 * duration }}>
        ...
        <div className="relative mt-8 sm:w-[600px]">
          <div
            className="scroll-fade-y h-[200px] overflow-scroll sm:h-[500px]"
            ref={ref}
          >
            <div>
              <AnimatePresence mode="popLayout">
                <motion.div
                  key={active.value}
                  className={cn(
                    "grid w-full grid-cols-2 gap-2 sm:grid-cols-[repeat(auto-fit,minmax(160px,1fr))] sm:gap-4",
