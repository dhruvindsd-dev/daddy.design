...
const Sidebar = ({}: Props) => {
  ...
  return (
    <>
      <AnimatePresence>
        {isM && sidebar_visible && (
          <motion.button
            ...
            className="fixed inset-0 z-101 bg-black/10"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
      ...
      <div className="fixed top-1/2 left-0 z-102 flex -translate-y-1/2 flex-col gap-8 sm:left-12">
